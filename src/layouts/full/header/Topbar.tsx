        ...
        <div className="py-[15px] px-6 z-40 sticky top-0 bg-[linear-gradient(90deg,_#0f0533_0%,_#1b0a5c_100%)]">
            <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
                <div className="md:flex hidden items-center gap-5">
                    {/* <Link target="_black" to="https://www.supamitrhospital.com/">
                    ...
                    {/* <div className="xl:flex items-center gap-4 pl-5 border-l border-opacity-20 border-white hidden">
                        <Link target="_black" to="https://www.supamitrhospital.com/" className="flex items-center gap-2 text-white bg-transparent hover:text-[#714bff]">
                ...
                <div className="flex flex-col md:flex-row items-center gap-4 justify-center">
                    ...
                    <div className="flex flex-col sm:flex-row items-center gap-[10px]">
                        <div className="flex items-center gap-[10px]">
                            ...
                            {/* <Link target="_black" to="https://www.supamitrhospital.com/" className="flex items-center px-4 py-[11px] rounded-sm gap-2 text-white bg-[#8d70f8] hover:bg-[#714bff]">
                                <Icon icon="solar:crown-linear" width={18} />
                                <h4 className="text-base font-normal leading-none text-white">Get Pro</h4>
                            </Link> */}
                        </div>
                        {/* <Link target="_black" to="https://www.supamitrhospital.com/" className="flex items-center px-4 py-[11px] rounded-sm gap-2 text-black bg-[#b3f143] hover:bg-[#90de03]">
